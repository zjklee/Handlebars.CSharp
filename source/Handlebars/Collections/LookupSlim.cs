...
{
    internal class LookupSlim<TKey, TValue> where TKey : class
    {
        private static readonly DictionaryPool<TKey, TValue> SharedPool = DictionaryPool<TKey, TValue>.Shared;
        ...
        public LookupSlim(IInternalObjectPoolPolicy<Dictionary<TKey, TValue>> policy)
        {
            Pool = new DictionaryPool<TKey, TValue>(policy);
            _inner = Pool.Get();
        }

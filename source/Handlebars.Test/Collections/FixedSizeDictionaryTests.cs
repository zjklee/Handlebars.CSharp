...
namespace HandlebarsDotNet.Test.Collections
{
    public class FixedSizeDictionaryTests : IDisposable
    {
        ...
        {
            FixedSizeDictionary = new FixedSizeDictionary<object, object, ObjectComparer>(17, new ObjectComparer());
        }
        ...
        public void Add()
        {
            for (int i = 0; i < 245; i++)
            {
                ...
                FixedSizeDictionary.Add(key, value, out var index);
        ...
        public void Copy()
        {
            ...
            var destination = new FixedSizeDictionary<object, object, ObjectComparer>(20, new ObjectComparer());
        ...
        public void CanAddAfterReset()
        {
            ...
            for (var i = 0; i < 245; i++)
            {
                ...
                FixedSizeDictionary.Add(key, value, out _);
            }
